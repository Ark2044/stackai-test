    ...
    <div className="min-h-[calc(100vh-4rem)] relative overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 text-center animate-fade-in">
        ...
        <div className="flex items-center justify-center gap-3 mb-4">
          ...
          <span className="text-xl font-semibold">Loading Models</span>
        </div>
        <p className="text-muted-foreground">Fetching available models...</p>
        ...
        <div className="mt-10 space-y-4 max-w-2xl mx-auto">
          {[1, 2, 3].map((i) => (
            <div 
              key={i} 
              className="h-32 rounded-2xl bg-card/30 backdrop-blur-sm border border-border/30 animate-pulse"
